...
router.get(
  ...
  ViewsController.renderViewsHome
);
...
router.get(
  "/login",
  authorization(["user", "admin"]),
  ViewsController.renderViewsLogin
);
...
router.get(
  ...
  jwtAuth,
  authorization(["user, admin"]),
  ViewsController.renderViewsProfile
);
...
router.get(
  ...
  jwtAuth,
  authorization(["admin"]),
  ViewsController.renderViewsRealTime
);
...
router.get(
  ...
  jwtAuth,
  authorization(["user, admin"]),
  ViewsController.renderViewsMessage
);
...
router.get(
  ...
  jwtAuth,
  authorization(["user", "admin"]),
  ViewsController.renderViewsProducts
);
...
router.get(
  "/cart/:cid",
  authorization(["user", "admin"]),
  ViewsController.renderViewsCart
);
